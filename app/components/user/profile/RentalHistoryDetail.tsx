  ...
  const renderRentalCard = (item: RentalHistoryItem) => (
    ...
    >
      ...
      >
        ...
        <View
          style={{ width: 1, backgroundColor: "#E5E7EB", marginHorizontal: 16 }}
        />
      ...
      >
        ...
        >
          ...
          <Text
            style={{ fontSize: 13, color: "#6B7280", marginLeft: 8, flex: 1 }}
          >
      ...
      <View>
        ...
        >
          <View style={{ flexDirection: "row", alignItems: "center", flexShrink: 1 }}>
            ...
            <Text style={{ fontSize: 12, color: "#9CA3AF", marginLeft: 4, flexShrink: 1 }}>
          ...
          {!item.isRented && (
            <View style={{ flexDirection: "row", alignItems: "center", flexShrink: 1 }}>
              ...
              <Text style={{ fontSize: 12, color: "#10B981", marginLeft: 4, flexShrink: 1 }}>
      ...
      >
        {isLoading ? (
            ...
            >
              ...
              >
                ...
                <View style={{ alignItems: "center" }}>
                  ...
                  >
                    {rentalHistory
                      .reduce((sum, item) => sum + item.rcPrice, 0)
                      .toFixed(2)}
                  </Text>
                  <Text
                    style={{
          ...
          >
            ...
            >
              You haven't rented any bikes yet. Start exploring and rent your
              first bike!
            </Text>
          </View>
        )}
