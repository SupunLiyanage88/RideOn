...
const BikeDetailsModal: React.FC<BikeDetailsModalProps> = ({
  ...
  const getConditionInfo = (condition: string | number) => {
    const conditionNum =
      typeof condition === "string" ? parseInt(condition) : condition;
    if (conditionNum >= 80)
      return {
        status: "Excellent",
        color: "#10B981",
    ...
    >
      <View style={styles.modalContainer}>
          ...
          <View style={styles.heroSection}>
            ...
            <View style={styles.mainInfo}>
              ...
              >
                ...
                />
                <Text
                  style={[styles.fuelTypeText, { color: fuelTypeInfo.color }]}
                >
          ...
          <View style={styles.statusSection}>
            ...
            <View style={styles.statusCards}>
              ...
              >
                ...
                />
                <Text
                  style={[styles.statusLabel, { color: conditionInfo.color }]}
                >
                  Condition
                </Text>
                <Text
                  style={[styles.statusValue, { color: conditionInfo.color }]}
                >
                ...
                <View style={styles.detailContent}>
                  ...
                  <Text style={styles.detailValue}>
                    {bike.fuelType.charAt(0).toUpperCase() +
                      bike.fuelType.slice(1)}
                  </Text>
                  <Text style={styles.detailDescription}>
                    {fuelTypeInfo.description}
                  </Text>
                </View>
              </View>
        ...
        <View style={styles.bottomAction}>
          <TouchableOpacity style={styles.editButtonLarge} onPress={onEdit}>
            <FontAwesome6 name="pen-to-square" size={18} color="#FFFFFF" />
